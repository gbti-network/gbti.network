...
export const SVG = {
  ...
  article: '<path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"/><path d="M16 8 2 22M17.5 15H9" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/>', // quill (Articles)
