...
export async function dispatch(ctx, { method = 'GET', pathname, query = {}, body } = {}) {
  ...
  try {
    ...
    // sow-271: the site toggles are public data by construction -- the same values are baked into every built
    // page, so a read reveals nothing a visitor cannot see. The WRITE below is superadmin, which is the gate.
