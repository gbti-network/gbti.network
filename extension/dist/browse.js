...
`;
  ...
  function applyAccount(root, status) {
    ...
    if (status) {
      ...
      if (adminItem) adminItem.hidden = (RANK4[status.role] ?? 0) < RANK4.moderator;
  ...
  // extension/src/browse.mjs
  var RAIL_KEY = { post: "articles", product: "products", prompt: "prompts", share: "shares" };
  var railFor = () => RAIL_KEY[parseBrowseHash(typeof location !== "undefined" ? location.hash : "").tab] || "articles";
