...
`;
  ...
  var RAIL_KEY = { all: "all", post: "articles", product: "products", prompt: "prompts", share: "shares" };
  var railFor = () => RAIL_KEY[parseBrowseHash(typeof location !== "undefined" ? location.hash : "").tab] || "all";
