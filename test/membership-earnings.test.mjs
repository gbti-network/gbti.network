...
test('returns the member\'s own earnings ledger from KV', async () => {
  const ledger = { v: 1, recipient: '42', entries: [{ from: 'm1', role: 'first', amount: 4500, currency: 'usd', invoice: 'in_1', state: 'payable' }], totals: { held: 0, payable: 4500, paid: 0, lifetime: 4500 } };
...
test('a member with no ledger yet gets an empty (zeroed) ledger, not a 404', async () => {
