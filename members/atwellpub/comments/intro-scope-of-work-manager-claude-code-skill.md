...
updatedAt: '2026-09-13T02:53:56.000Z'
type: comment
author: atwellpub
---
...
- creates the lane folders `0_queue`, `1_progressing`, `2_completed`, and a `_staging` side-lane
...
- searches the open SOWs first (queue, in progress, and staging) and folds the request into an existing SOW when one fits, instead of creating a duplicate
