---
type: project
title: "WordPress Perplexity Plugin"
slug: wordpress-perplexity-plugin
author: atwellpub
status: published
visibility: public
shortDescription: "This lightweight WordPress plugin adds a Perplexity lookup to highlighted text inside your WordPress blog posts."
categories: ["devops", "frameworks", "wordpress"]
icon: "./images/wordpress-perplexity-plugin-icon-128x128-1.webp"
publishedAt: 2025-06-30
banner: "./images/github-product-banner-wordpress-perplexity-plugin.webp"
featuredImage: "./images/wordpress-perplexity-plugin-featured.webp"
gallery:
  - "./images/wordpress-perplexity-plugin-shot-1.webp"
  - "./images/wordpress-perplexity-plugin-shot-2.webp"
video: "ap7CkB019M8"
links:
  - { type: download, url: "https://github.com/gbti-network/wordpress-perplexity-plugin", primary: true }
  - { type: repository, url: "https://github.com/gbti-network/wordpress-perplexity-plugin" }
redirectFrom:
  - "/products/wordpress-perplexity-plugin/"
---
