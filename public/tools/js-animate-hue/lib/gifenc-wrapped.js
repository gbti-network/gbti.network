...
var src_default = GIFEncoder;
  ...
  // Expose gifenc to global scope
  window.gifenc = {
    GIFEncoder: exports.GIFEncoder,
    quantize: exports.quantize,
    applyPalette: exports.applyPalette,
    nearestColor: exports.nearestColor,
    nearestColorIndex: exports.nearestColorIndex,
    nearestColorIndexWithDistance: exports.nearestColorIndexWithDistance,
    prequantize: exports.prequantize,
    snapColorsToPalette: exports.snapColorsToPalette
  };
  
  // Also expose exports object for compatibility
  window.exports = exports;
  
  console.log('Gifenc loaded successfully for browser use');
})();
