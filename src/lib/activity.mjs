...
// projects, prompts) emitted at build time as /activity-index.json, which the extension new-tab page reads to
...
// prolific type crowd the others out of the river (24 prompts left room for only 8 posts + 8 projects); now
...
/**
 * @typedef {{ type: 'post'|'project'|'prompt', slug: string, title: string, author: string, url: string, publishedAt: number|null, visibility: 'public'|'members' }} ActivityEntry
 */
