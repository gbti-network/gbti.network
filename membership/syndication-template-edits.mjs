...
import { TEMPLATE_TYPES, NEWS_ENGAGEMENT_TIERS, newsEngagement, syndicationConfigFromParsed, AUTO_TYPES, MATRIX_CHANNELS, AUTO_MODES, channelCapability } from './syndication-config-core.mjs';
...
export function setSyndicationSettings(doc, { enabled, requireApproval, holdMinutes, channels, autoMatrix, channelHoldMinutes } = {}, ctx = {}) {
  ...
  // SOW-125: the per-type-per-channel auto-share matrix ({ type: { channel: 'off'|'on'|'on-manual' } }). Only
